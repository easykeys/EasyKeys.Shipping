                    ...
                    ExportDeclaration = new ExportDeclaration
                    {
                        LineItems = new[]
                        {
                            new LineItems2
                            {
                                ...
                                CustomerReferences = new[]
                                {
                                    new CustomerReferences3 { TypeCode = CustomerReferences3TypeCode.PON, Value = "PO NUMBER 2" }
                                },
                        ...
                        Invoice = new Invoice2
                        {
                            ...
                            CustomerReferences = new[]
                            {
                                new CustomerReferences4 { TypeCode = CustomerReferences4TypeCode.PON, Value = "PO NUMBER 2" },
