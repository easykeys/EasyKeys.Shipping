...
public class StampsRateConfiguratorTests
{
    ...
    [Theory]
    [InlineData(8.0, 4.0, 0.75, 15.99, 6)]
    [InlineData(8.0, 4.0, 0.75, 5, 7)]
    [InlineData(8.0, 4.0, 0.75, 0.5, 8)]
    [InlineData(6.0, 2.0, 2, 4, 7)]
    [InlineData(11.0, 8.0, 2, 32, 4)]
